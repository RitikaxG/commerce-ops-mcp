...
| `operations.review_reason_code`        | All diagnosis codes plus `MISSING_EVIDENCE`, `CONFLICTING_EVIDENCE`                                                                                                                                              | Supports diagnosed and uncertainty-based handoffs without inventing a diagnosis. |
